...
breed_to_image_uri = {
    "Cocos1": "https://ipfs.io/ipfs/QmSsYRx3LpDAb1GZQm7zZ1AuHZjfbPkD6J7s9r41xu1mf8?filename=pug.png",
    "Cocos2": "https://ipfs.io/ipfs/QmYx6GsYAKnNzZ9A6NvEKV9nf1VaDzJrqDR23Y8YSkebLU?filename=shiba-inu.png",
    "Cocos3": "https://ipfs.io/ipfs/QmUPjADFGEKmfohdTaNcWhp7VGk26h5jXDA7v3VtTnTLcW?filename=st-bernard.png",
}
...
def upload_to_ipfs(filepath):
    with Path(filepath).open("rb") as fp:
        ...
        image_uri = "https://ipfs.io/ipfs/{}".format(
            ipfs_hash)
        print(image_uri)
    return image_uri
